...
#    os.chdir(r"/local/home/earnor/infraScan/")
    ...
    limits_corridor = [e_min, n_min, e_max, n_max] #TODO: define Dübendorf–Hinwil corridor
    ...
    # Noise costs, TODO: necessary for cycling?
    ...
    # Nature and Landscape #TODO: what is this? Is it necessary?
    ...
    # Read the network dataset to avoid running the function above TODO: point to new network 3a
    network = gpd.read_file(r"data/temp/network_highway.gpkg")

    # Import manually gathered access points and map them on the highway infrastructure #TODO: create access points Task 3c
    ...
    # Connect the generated points to the existing access points #TODO 3c
