...
# Load new edges
new_edges_new_access = gpd.read_file(r"data\Network\processed\new_links_realistic_new_access.gpkg")
new_edges_new_connections = gpd.read_file(r"data\Network/processed/new_links_realistic_new_connections.gpkg")
